...
Public Class Frm_ReporteProveedores1
    ...
    Private Sub Frm_ReporteProveedores1_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        conexion.ConnectionString = "server=.; DataBase=TiendaDeRopa; Integrated Security=SSPI"
        conexion.Open()

        comando.CommandText = "Select ciudad From proveedores group by ciudad"
    ...
    Private Sub cmdImprimir_Click(sender As Object, e As EventArgs) Handles cmdImprimir.Click
        ...
        Adaptador.SelectCommand.CommandText = "REPORTEPROVEEDOR"
        Adaptador.SelectCommand.CommandType = CommandType.StoredProcedure
        Dim param1 = New SqlParameter("@CIU", SqlDbType.VarChar)
        ...
        Dim p1 As New ReportParameter("CIU", nombre)
        ...
        Frm_Reportes.ReportViewer1.LocalReport.ReportPath = "C:\Users\misae\Documents\DISI\TiendaDeRopa\TiendaDeRopa\ReporteProveedores1.rdlc"
